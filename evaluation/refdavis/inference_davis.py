...
def main(args):
    ...
    # ---------------------------- read data ------------------------------------
    meta_exp_path = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/davis17/meta_expressions/valid/meta_expressions.json"
    meta_exp = json.load(open(meta_exp_path, 'r'))
    video_folder = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/davis17/valid/JPEGImages"
    ...
    print(f"RefDAVIS: Total {len(vid_id_list)} videos, {len(job_list)} jobs.")
