...
if __name__ == '__main__':
    ...
    parser.add_argument("--meta_exp_path", type=str, default="/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/ReasonVOS/meta_expressions.json")
    parser.add_argument("--mask_path", type=str, default="/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/ReasonVOS/Annotations")
