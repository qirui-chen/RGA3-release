...
if __name__ == '__main__':
    ...
    parser.add_argument("--mevis_exp_path", type=str, default="/PATH/TO/mevis/valid_u/meta_expressions.json")
    parser.add_argument("--mevis_mask_path", type=str, default="/PATH/TO/mevis/valid_u/mask_dict.json")
