...
class LlavaPhiForCausalLM(Phi3ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        vip_imgs_list: Optional[List[torch.FloatTensor]] = None,
        vip_masks_list: Optional[List[torch.FloatTensor]] = None,
    ...
    def generate(
        ...
        **kwargs,
        ...
        vip_imgs_list = kwargs.pop("vip_imgs_list", None)
        vip_masks_list = kwargs.pop("vip_masks_list", None)
        ...
        if images is not None:
            (
                ...
                vip_imgs_list=vip_imgs_list,
                vip_masks_list=vip_masks_list,
            )
        else:
