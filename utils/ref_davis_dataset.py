...
from .utils import ANSWER_LIST, SHORT_QUESTION_LIST, rank0_print
from .utils import preprocess, DirectResize


class RefDAVIS_Dataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/davis17"
        ...
        rank0_print('Using Ref-DAVIS-17 training set')
...
class RefDAVISDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        assert len(sample_indx) == self.num_frames, f"{vid_len}, {sample_indx}, {global_inds}, {global_n}"
...
if __name__ == '__main__':
    base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/davis17"
    num_frames = 32
