...
class YTVOS_Dataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.VOS = VOSDataset(
            im_root="/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/YTVOS19/train/JPEGImages",
            gt_root="/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/YTVOS19/train/Annotations",
            max_jump=20,
            num_frames=num_frames_mllm,
        )

        rank0_print("Using YTVOS data.")
...
class VOSDataset(Dataset):
    ...
    def __init__(self, im_root, gt_root, max_jump, num_frames=3, is_bl=False, subset=None):
        ...
        self.meta = json.load(
            open(
                "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/YTVOS19/train/meta.json",
                "r",
            )
        )
