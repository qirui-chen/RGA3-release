...
class MeViS_Dataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/mevis"
        ...
        self.MeViS_valid_u = MeViSDataset(img_folder=os.path.join(self.base_image_dir, "valid_u"),
                                          ...
                                          num_frames=self.num_frames_mllm)
        rank0_print('Using MeViS dataset, {} from train, {} from valid_u'.format(len(self.MeViS_train), len(self.MeViS_valid_u)))
...
class MeViSDataset(Dataset):
    ...
    def __init__(self,
        ...
        rank0_print(f'Loading masks form {mask_json} ...')
...
if __name__ == '__main__':
    base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/mevis/"
