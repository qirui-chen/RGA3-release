...
class ReferYTVOSDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/Ref-Youtube-VOS"
        ...
        rank0_print('Using Ref-YouTube-VOS dataset')
...
if __name__ == '__main__':
    base_image_dir = "/mnt/ali-sh-1/dataset/zeus/chenqr/datasets/qrchen_dataset/other-datasets/Ref-Youtube-VOS/"
    num_frames = 4
